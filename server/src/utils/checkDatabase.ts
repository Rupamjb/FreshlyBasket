...
const checkDatabase = async () => {
  try {
    ...
    if (sampleProduct) {
      ...
      // Safely show product fields with type checking
      Object.entries(sampleProduct as Record<string, unknown>).forEach(([key, value]) => {
        // Safely convert value to string with type checking
        let displayValue = '';
