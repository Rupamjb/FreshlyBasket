...
const SignupModal: React.FC<SignupModalProps> = ({ isOpen, onClose, onToggleToLogin }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMsg = err instanceof Error ? err.message : 'Failed to sign up. Please try again.';
      setError(errorMsg);
        ...
        <form className="form_container" onSubmit={handleSubmit}>
          ...
          <div className="input_container">
            ...
            <svg fill="none" viewBox="0 0 24 24" height={24} width={24} xmlns="http://www.w3.org/2000/svg" className="icon">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" stroke="#0F5132" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
            </svg>
            <input 
          ...
          <button title="Sign Up" type="submit" className="sign-in_btn" disabled={isLoading}>
          ...
          <div className="login-link">
            ...
            <LoginButton onClick={onToggleToLogin}>
              Log in
            </LoginButton>
          </div>
