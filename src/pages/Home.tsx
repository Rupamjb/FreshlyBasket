...
const Home = () => {
  ...
  return (
    <div ref={homeRef} className="min-h-screen bg-gray-50 scroll-container">
      ...
      <div className="hidden md:block sticky top-0 z-10 bg-white border-b border-gray-200 shadow-sm">
      ...
      {/* Hero Section */}
      <section className="relative bg-neutral-100 overflow-hidden hero-section mb-0 pb-8 md:pb-16">
      ...
      <section className="py-8 md:py-10 bg-gray-50 border-t border-b border-gray-200">
        <div className="container mx-auto px-4 content-container">
          <div className="flex justify-between items-center mb-6">
      ...
      <div className="bg-white">
        ...
        <section className="py-8 md:pt-10 md:pb-4">
          <div className="container mx-auto px-4 content-container">
            <div className="flex justify-between items-center mb-6">
        ...
        {/* Visual divider */}
        <div className="border-b border-gray-100 mx-auto w-[95%] max-w-[1200px] md:block hidden"></div>

        {/* New Arrivals Section */}
        <section className="py-6 md:pt-4 md:pb-6">
          <div className="container mx-auto px-4 content-container">
            <div className="flex justify-between items-center mb-6">
        ...
        <section className="py-8 md:pt-6 md:pb-12">
          <div className="container mx-auto px-4 content-container">
            <div className="flex justify-between items-center mb-6">
